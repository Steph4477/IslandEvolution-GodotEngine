...
# ========================== RÉGLAGES ==========================
@export var lance_scene = preload("res://Shoot/Enemies/Spear/spear.tscn")
...
func shoot_lance():
	...
	lance.start(lance_spawn.global_position, facing)  # ✅ 1 ou -1
...
func show_damage_popup(amount):
	var popup_scene = preload("res://Interface/Popup/Damage_popup/damage_popup.tscn")
